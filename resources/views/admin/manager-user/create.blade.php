...
@section('title')
    <a href="{{route('admin.manager-user.index')}}">Manajemen User</a> - Tambah User
@endsection
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body p-3">
                            ...
                            <form action="{{route('admin.manager-user.store')}}" method="post" role="form">
                                @csrf
                                ...
                                <div class="form-group row mb-4">
                                    <label
                                        class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Aktor</label>
                                    <div class="col-sm-12 col-md-7">
