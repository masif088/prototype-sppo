...
@section('title')
    <a href="{{route('admin.manager-parent.index')}}">Manajemen Siswa</a> - Ubah Siswa - {{$user->name}}
@endsection
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body p-3">
                            <form action="{{route('admin.manager-parent.edit',$user->id)}}" method="post" role="form">
                                @csrf
                                {{method_field('PUT')}}
