...
@section('title')
    <a href="{{route('admin.manager-student.index')}}">Manajemen Siswa</a> - Ubah Siswa - {{$user->name}}
@endsection
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body p-3">
                            <form action="{{route('admin.manager-student.update',$user->id)}}" method="post" role="form">
                                @csrf
                                {{method_field('PUT')}}
