    ...
    if(!mini) {
      ...
      $(".main-sidebar .sidebar-menu > li").each(function() {
        ...
        if(me.find('> .dropdown-menu').length) {
          ...
          me.find('> .dropdown-menu').prepend('<li manager-class="dropdown-title pt-3">'+ me.find('> a').text() +'</li>');
        }else{
  ...
  $("[data-collapse]").each(function() {
    ...
    me.click(function() {
      ...
      $(target).on('shown.bs.collapse', function(e) {
        e.stopPropagation();
        me.html('<i manager-class="fas fa-minus"></i>');
      });
      $(target).on('hidden.bs.collapse', function(e) {
        e.stopPropagation();
        me.html('<i manager-class="fas fa-plus"></i>');
      });
      return false;
    });
  });
